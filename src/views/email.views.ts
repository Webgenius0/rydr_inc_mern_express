export interface TOtpEmailTemplateParams {
  title?: string;
  email_otp: string;
...
export interface TPasswordChangedTemplateParams {
  name?: string;
  footer?: string;
}

export interface TContactMessageTemplateParams {
  name: string;
  email: string;
  phone: string;
  message: string;
...
export const otpEmailTemplate = ({
  ...
  <div style="font-family: Arial, sans-serif; padding: 40px; background-color: #f9f9fb;">
    <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05); padding: 40px;">
      <h2 style="color:#2563eb; font-size: 24px; font-weight:600; margin-bottom:5px;">Rydr</h2>
      ...
      <p style="font-size: 16px; color: #111827; margin-top: 8px;">Here is your One-Time Password to securely access your Rydr account:</p>
      <h1 style="font-size: 32px; color: #2563eb; margin: 30px 0; letter-spacing: 4px;">${email_otp}</h1>
      ...
      <p style="margin-top: 40px; color: #1f2937;">Thank you for being part of Rydr!</p>
  ...
  <div style="font-family: Arial, sans-serif; padding: 40px; background-color: #f9f9fb;">
    <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.05); padding: 40px;">
      ...
      <p style="font-size: 16px; color: #111827; margin-top: 8px;">
        We wanted to let you know that your Rydr account password has been changed successfully.  
